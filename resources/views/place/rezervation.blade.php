                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('booking.store')}}" >
                            ...
                            <div class="row mb-3">
                                    <div>
                                    <label for="period" class="col-md-4 col-form-label text-md-end">{{ __('Atvikimas') }}</label>
                            ...
                            <div class="row mb-3">
                                <div>
                                    <label for="period" class="col-md-4 col-form-label text-md-end">{{ __('Išvikimas') }}</label>
                                    <div class="form-group">
                                        <div class='input-group date' id='datetimepicker'>
                                            <input type="hidden" id="rezervdate" value="{{$dates}}">
